...
import NewMessageFilePreview from "./NewMessageFilePreview";
import NewMessageImagesPreview from "./NewMessageImagesPreview";
...
const NewMessageForm = ({ messageType }: { messageType: string }) => {
    ...
    <div className="p-4 bg-gray-100 border-t border-gray-300 flex  justify-between items-center relative">
      ...
      {(imagePreview.length > 0 || filePreview.length > 0) && (
        <div className="flex flex-wrap gap-2 w-[97%] absolute bottom-16 bg-gray-300 p-2 rounded-md">
          <NewMessageImagesPreview
            imagePreview={imagePreview}
            setImagePreview={setImagePreview}
            images={images}
            setImages={setImages}
          />
          <NewMessageFilePreview
