...
router.get("/cards/:adminId", team_controller_1.TeamController.getTeamsForCard);
...
router.patch("/remove-member/:teamId/:memberId", team_controller_1.TeamController.removeMember);
