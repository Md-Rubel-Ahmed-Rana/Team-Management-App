...
router.post("/create", cloudinary_1.upload.single("file"), (0, cloudinary_1.uploadSingleFile)("team-logos"), (0, validateRequest_1.default)(team_validation_1.TeamValidationSchema.createTeamValidation), team_controller_1.TeamController.createTeam);
router.get("/", team_controller_1.TeamController.getAllTeams);
router.get("/single/:id", team_controller_1.TeamController.getSingleTeam);
router.get("/my-teams/:adminId", team_controller_1.TeamController.getMyTeams);
router.get("/joined-teams/:memberId", team_controller_1.TeamController.getJoinedTeams);
